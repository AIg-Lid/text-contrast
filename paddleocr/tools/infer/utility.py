...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default=r"C:\Users\user3376\Desktop\text-contrast\paddleocr\models\ch_PP-OCRv3_det_infer")
    ...
    parser.add_argument("--rec_model_dir", type=str, default=r"C:\Users\user3376\Desktop\text-contrast\paddleocr\models\ch_PP-OCRv3_rec_infer")
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=r"C:\Users\user3376\Desktop\text-contrast\paddleocr\models\ppocr_keys_v1.txt")
    ...
    parser.add_argument("--cls_model_dir", type=str, default=r"C:\Users\user3376\Desktop\text-contrast\paddleocr\models\ch_ppocr_mobile_v2.0_cls_infer")
